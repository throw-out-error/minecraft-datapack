import {hasIllegalCharsSlash,mkdirIfNotExist,jsonBeautify,getDirname,fs,itemArrayFromString} from "./utility";
...
class Recipe {
     ...
     */
    constructor(path:string,type:'smelting'|'shapeless'|'shaped'|'stonecutting'){
...
class SmeltingRecipe extends Recipe {
     ...
     */
    constructor(path:string,options:{type?:'minecraft:smelting'|'minecraft:blasting'|'minecraft:campfire_cooking'|'smelting',ingredient:string,result:string,experience:number,cookingtime?:number}){
        super(path,'smelting');
...
class StonecutterRecipe extends Recipe {
     ...
     */
    constructor(path:string,options:{ingredient:string,result:string,count?:number}){
...
class ShapelessCraftingRecipe extends Recipe {
     ...
     */
    constructor(path:string,options:{ingredients:string[],result:string,count?:number}){
...
class ShapedCraftingRecipe extends Recipe {
     ...
     * @param {number} [options.count=1] The amount of the resulting item
     */
    constructor(path:string,options:{pattern:string[],key:object,result:string,count?:number}){
        super(path,'shaped')
        this.file_contents={
