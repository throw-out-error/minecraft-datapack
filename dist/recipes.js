...
class Recipe {
    ...
    compile(path) {
        ...
        utility_1.mkdirIfNotExist(utility_1.getDirname(recipePath));
        utility_1.fs.writeFileSync(recipePath, utility_1.jsonBeautify(this.file_contents));
    }
    /**
...
class SmeltingRecipe extends Recipe {
    ...
    constructor(path, options) {
        ...
        this.file_contents = {
            ...
            ingredient: utility_1.itemArrayFromString(options.ingredient),
...
class ShapelessCraftingRecipe extends Recipe {
    ...
    constructor(path, options) {
        ...
        this.file_contents = {
            ...
            ingredients: options.ingredients.map(ingredient => utility_1.itemArrayFromString(ingredient)),
            result: {
                item: options.result,
                count: options.count || 1
            }
